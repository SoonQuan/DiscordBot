...
class SDSGC(commands.Cog):
  ...
  async def pull(self,ctx,arg1=None):
    ...
    banner_list = sorted(["T1","MONO","SLIME","VAL","AM","DZ","MERLIN","FZEL", "REZERO", "ST", "EXARTH", "ELAINE", "FBAN", "FLIZ", "FGOW", "FKING", "FDIANE", "DMELI", "SARIEL", "TARMIEL", "HAWK", "SDIANE", "CAP","SEASON", "BRUN", "RAGBAN", "RAG1", "RAG2", "RAG3", "RAG4", "RAG5", "RAG6", "SROXY","SMLH", "LUDO", "CUSACK", "EMO", "HMATRONA", "MELA", "HDIANE", "XLILLIA", "XLIZ", "KOF"])
    d={}
    out = []
    if arg1 == "list":
      n = 10
    ...
    dirs = []
    ban6p = ["DZ"]
    ban4p = ["T1","AM","MERLIN","FZEL","FBAN", "FLIZ","LUDO", "CUSACK", "FGOW", "FKING", "FDIANE", "DMELI"]
    ban3p = ["MONO","SLIME","VAL","REZERO","ST","EXARTH", "ELAINE","HAWK", "SDIANE", "CAP", "SARIEL", "TARMIEL","SEASON", "BRUN", "RAGBAN", "RAG1", "RAG2", "RAG3", "RAG4", "RAG5", "RAG6", "SROXY", "SMLH", "EMO", "HMATRONA", "MELA", "HDIANE", "XLILLIA", "XLIZ", "KOF"]
