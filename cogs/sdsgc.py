...
class SDSGC(commands.Cog):
  ...
  async def pull(self,ctx,arg1=None):
    ...
    banner_list = sorted(["T1","MONO","SLIME","VAL","AM","ESTA","DZ","MERLIN","FZEL", "REZERO", "ST", "EXARTH", "ELAINE", "FBAN", "FLIZ", "FGOW", "FKING", "FDIANE", "DMELI", "SARIEL", "TARMIEL", "HAWK", "ONZEL", "SDIANE", "CAP","SEASON", "BRUN", "RAGBAN", "RAG1", "RAG2", "RAG3", "RAG4", "RAG5", "RAG6", "RAG7",  "SROXY","SMLH", "LUDO", "CUSACK", "EMO", "HMATRONA", "MELA", "HDIANE", "XLILLIA", "XLIZ", "KOF"])
    d={}
    out = []
    if arg1 == "list":
      n = 10
    ...
    ban3p = ["MONO","SLIME","VAL","REZERO","ST","EXARTH", "ELAINE", "HAWK", "ONZEL", "SDIANE", "CAP", "SARIEL", "TARMIEL","SEASON", "BRUN", "RAGBAN", "RAG1", "RAG2", "RAG3", "RAG4", "RAG5", "RAG6", "RAG7",  "SROXY", "SMLH", "EMO", "HMATRONA", "MELA", "HDIANE", "XLILLIA", "XLIZ", "KOF"]
