...
class SDSGC(commands.Cog):
  ...
  async def pull(self,ctx,arg1=None):
    ...
    if bal[0] < 30:
      ...
      em.set_footer(text= "try !timely")
      return await ctx.send(embed = em)
    banner_list = sorted(["T1","VAL","AM","DZ","MERLIN","FZEL", "REZERO", "ST", "EXARTH", "FBAN", "FGOW","HAWK","SEASON", "RAG1", "RAG2", "SROXY","SMLH", "LUDO", "CUSACK", "EMO", "HMATRONABanner", "HDIANE", "KOF"])
    d={}
    out = []
    if arg1 == "list":
      n = 10
    ...
    ban3p = ["VAL","REZERO","ST","EXARTH","HAWK","SEASON", "RAG1", "RAG2", "SROXY", "SMLH", "EMO", "HMATRONABanner", "HDIANE", "KOF"]
